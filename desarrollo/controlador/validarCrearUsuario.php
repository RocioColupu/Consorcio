<?php
	...
	if(isset($_POST['registra'])){
		...
		$registros = "SELECT usuario FROM usuario WHERE usuario ='$usuario' || correo='$correo'";
		...
		if ($entro){
            // msj en javascript
			echo '<script>alert("Usuario y/o correo existente"); </script>';
			// ir al panel.php
			echo '<script>window.location="../vista/nuevoregistro.php"; </script>';
        }else{
			// error
